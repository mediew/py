...
class LoanCalculator:
    def __init__(self):
        ...
        Label(window, text = 'Annual Interest Rate').grid(row \
            = 1, column = 1, sticky = W)
        ...
        lblTotalPayment = Label(window, textvariable = \
            ...
            sticky = E)
        btComputePayment = Button(window, text = 'compute \
            payment', command = self.computePayment).grid( \
    ...
    def getMonthlyPayment(self, loanAmount, monthlyInterestRate,
            numberOfYears):
