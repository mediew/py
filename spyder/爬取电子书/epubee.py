...
def get_url_list():
    ...
    lst20 = list(map(str, range(10, 19)))
    index_lst = lst10 + lst20
    lst = ['http://reader.epubee.com/books/mobile/f3/f309f34a19e6392ca1385a0b352b7de0/text000{}.html'.format(i) for i in index_lst]
    return lst
...
def get_content(url, headers):
    ...
    con_lst = []
    base_url = 'http://reader.epubee.com/books/mobile/f3/f309f34a19e6392ca1385a0b352b7de0/'
